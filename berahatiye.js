...
const body = document.querySelector(".izah");
...
function theme() {
  if (input.checked) {
    ...
    toggle.style.background = "#1c1c1e";
    toggle.style.color = "#f5f5f7";
    list.style.backgroundImage = "linear-gradient(to right, #28282B 0%, #353935 80%)";
  } else {
    body.style.background = "#f5f5f7";
    body.style.color = "#000000";
    html.style.background = "#496a83"
    toggle.style.background = "#f5f5f7";
    toggle.style.color = "#000000";
    list.style.backgroundImage = "linear-gradient(to right, #5b6467 0%, #8b939a 75%)";
  }
}
...
document.addEventListener("DOMContentLoaded", function () {
      ...
      <p>Bütün Almanca deyimleri ne yazık ki barındırmaz.</p>
      ...
      <p><b>Paroli bieten:</b> Efelenmek. <b>NOT:</b> Paroli; bir kumar sistemidir.</p>
...
<p>Ne yazık ki bütün Almanca atasözlerini barındırmaz.</p>
